...
class Polygon{
  ...
  void colorByScore(){
    fill = color(score);
    //if (score <= 7) { fill = color(250);
    //}
    //else if (score <= 16 && score>= 7.1) { fill = color(200);
    //}
    //else if (score <= 28 && score>= 16.1) { fill = color(150);
    //}
    //else if (score <= 46 && score>= 28.1) { fill = color(100);
    //}
    //else if (score>= 46.1) { fill = color(50);
    //}
  }
